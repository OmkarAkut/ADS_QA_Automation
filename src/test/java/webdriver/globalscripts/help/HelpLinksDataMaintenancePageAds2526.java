...
public class HelpLinksDataMaintenancePageAds2526 extends PageTestHelper {
	...
	public void test01MaintainDataPageActivitiesSectionHelpLinks() throws Throwable {
		...
		try {
			...
			driver.findElement(By.xpath("//span[text()='General']/preceding-sibling::div")).click();
			waitForSpinnerToEnd();
			waitForAjaxExtJs();
			...
			for (String folder : folders) {
				...
				driver.findElement(By.xpath("//span[text()='" + folder + "']/../div[contains(@class, 'x-tree-elbow-img x-tree-elbow-plus x-tree-expander')]")).click();
				waitForSpinnerToEnd();
				waitForAjaxExtJs();
				Thread.sleep(3000);
				//        Omkar 28/03/2023 : Xpath change for 11.2
				//        WebElement list = driver.findElement(By.xpath("//div[text()='" + folder + "']/ancestor::table/tbody"));
				WebElement list = driver.findElement(By.xpath("//span[text()='" + folder + "']/ancestor::table/tbody"));
...
//						driver.findElement(By.xpath("//div[contains(@id,'warningwindow')]/descendant::button/span[text()='OK']")).click();
						driver.findElement(By.xpath("//div[contains(@id,'warningwindow')]/descendant::span[text()='OK']")).click();
					}
...
//				driver.findElement(By.xpath("//div[text()='" + folder + "']/img[contains(@class, 'x-tree-expander')]")).click(); //closes expanded folder
				driver.findElement(By.xpath("//span[text()='" + folder + "']/../div[contains(@class, 'x-tree-expander')]")).click(); //closes expanded folder
				waitForAjaxExtJs();
			}
