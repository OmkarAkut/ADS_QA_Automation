...
public class BuildVerificationTestScript extends UcqcHelper {
	 ...
	 * /
	 * 
	 * @BeforeClass public static void setupScript() throws Exception,Throwable {
	 *              ExtentReport.reportCreate("BuildVerificationTestScript",
	 *              "webdriver.globalscripts.pagetests",
	 *              "BuildVerificationTestScript"); try { generalElement =
	 *              BuildMap.getInstance(driver, GeneralElementsMap.class);
	 *              analyticsMap = BuildMap.getInstance(driver, AnalyticsMap.class);
	 *              contractingMap = BuildMap.getInstance(driver,
	 *              ContractingMap.class); costingMap = BuildMap.getInstance(driver,
	 *              CostingMap.class); statusMap = BuildMap.getInstance(driver,
	 *              StatusMap.class); dialogsMap = BuildMap.getInstance(driver,
	 *              DialogsMap.class); dataMaintenance =
	 *              BuildMap.getInstance(driver, DataMaintenanceMap.class);
	 *              modelLibrary = BuildMap.getInstance(driver,
	 *              ModelLibraryMap.class); reportingMap =
	 *              BuildMap.getInstance(driver, ReportingMap.class); sysmaint =
	 *              BuildMap.getInstance(driver, SystemMaintenanceMap.class);
	 *              System.out.println("Test Class: " +
	 *              BuildVerificationTestScript.class.getSimpleName());
	 *              ExtentReport.logPass("PASS", "setupScript"); } catch
	 *              (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *              "Failure in setupScript", driver, e); fail(e.getMessage()); } }
	 *              /*Commented below test cases as they are executing under Smoke
	 *              Test //Login page tests
	 * @Test public void test0000VerifyLoginPageIsDisplayed() throws Throwable {
	 *       System.out.println("Testing Login Page"); try { waitForSpinnerToEnd();
	 *       Thread.sleep(1000);
	 *       wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//img[@alt
	 *       = 'Harris Affinity Logo']"))); ExtentReport.logPass("PASS",
	 *       "test0000VerifyLoginPageIsDisplayed"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000VerifyLoginPageIsDisplayed", driver, e); fail(e.getMessage());
	 *       } }
	 * 
	 * @Test public void test0000aVerifyLoginPageElementsAreDisplayed() throws
	 *       Throwable { try { WebElement[] logInPageElements = {
	 ...
	 *       "test0000aVerifyLoginPageElementsAreDisplayed"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000aVerifyLoginPageElementsAreDisplayed", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 * @Test public void test0000bLoginPageVerifyCurrentDateIsDisplayed() throws
	 *       Throwable { try { LocalDateTime now = LocalDateTime.now(); if
	 *       (printout) { System.out.println(DateTimeFormatter.ofPattern("EEEE MMMM
	 *       d, yyy HH:mm a").format(now)); } //String expectedDate =
	 *       DateTimeFormatter.ofPattern("EEEE MMMM dd, yyy HH:mm a").format(now);
	 *       String expectedDate = DateTimeFormatter.ofPattern("EEEE MMMM d,
	 *       yyy").format(now); String actualLoginPageDate =
	 *       generalElement.getLoginPageDate().getText();
	 *       assertThat(actualLoginPageDate, containsString(expectedDate));
	 *       ExtentReport.logPass("PASS",
	 *       "test0000bLoginPageVerifyCurrentDateIsDisplayed"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000bLoginPageVerifyCurrentDateIsDisplayed", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 * @Test public void test0000cLoginPageVerifyReleaseVersion() throws Throwable {
	 *       try { String actualReleaseVersion =
	 *       generalElement.getLoginPageReleaseVersion().getText(); if (printout) {
	 *       System.out.println("Expected release version: " +
	 *       expectedReleaseVersion); System.out.println("Actual release version: "
	 *       + actualReleaseVersion); } assertThat(actualReleaseVersion,
	 *       containsString(expectedReleaseVersion)); ExtentReport.logPass("PASS",
	 *       "test0000cLoginPageVerifyReleaseVersion"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000cLoginPageVerifyReleaseVersion", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 * @Test public void test0000dLoginPageVerifyHarrisLogoImage() throws Throwable
	 *       { try { if (printout) { System.out.println("Actual Login Page Logo id:
	 *       " + generalElement.getLoginPageLogo().getAttribute("id"));
	 *       System.out.println("Actual Login Page partial Logo src: " +
	 *       generalElement.getLoginPageLogo().getAttribute("src").substring(23)); }
	 *       assertThat(generalElement.getLoginPageLogo().getAttribute("id"),
	 *       containsString("image-1013"));
	 *       assertThat(generalElement.getLoginPageLogo().getAttribute("src").substring(23),
	 *       containsString("/resources/images/app/Harris_Affinity_Logo.png"));
	 *       ExtentReport.logPass("PASS",
	 *       "test0000dLoginPageVerifyHarrisLogoImage"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000dLoginPageVerifyHarrisLogoImage", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 * @Test public void test0000eLoginPageVerifyLogInPageHeaderIsLogIn() throws
	 *       Throwable { try { if (printout) { System.out.println("Login Page
	 *       Header: " + generalElement.getLoginPageHeaderLogIn().getText()); }
	 *       assertThat(generalElement.getLoginPageHeaderLogIn().getText(),
	 *       containsString("Log In")); ExtentReport.logPass("PASS",
	 *       "test0000eLoginPageVerifyLogInPageHeaderIsLogIn"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000eLoginPageVerifyLogInPageHeaderIsLogIn", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 * @Test public void test0000fLoginPageVerifySignInSectionHeaderIsSignIn()
	 *       throws Throwable { try { if (printout) { System.out.println("Login Page
	 *       Sign In section header: " +
	 *       generalElement.getLoginPageLogInHeaderSignIn().getText()); }
	 *       assertThat(generalElement.getLoginPageLogInHeaderSignIn().getText(),
	 *       containsString("Sign In")); ExtentReport.logPass("PASS",
	 *       "test0000fLoginPageVerifySignInSectionHeaderIsSignIn"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000fLoginPageVerifySignInSectionHeaderIsSignIn", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 * @Test public void
	 *       test0000gLoginPageVerifyUsernameAndPasswordFieldLabelsAreDisplayed()
	 *       throws Throwable { try { if (printout) { System.out.println("Login Page
	 *       Username label: " + driver.findElement(By.xpath("//label[text() =
	 *       'Username']"))); System.out.println("Login Page Password label: " +
	 *       driver.findElement(By.xpath("//label[text() = 'Password']"))); }
	 *       assertThat(driver.findElement(By.xpath("//label[text() =
	 *       'Username']")).isDisplayed(), equalTo(true));
	 *       assertThat(driver.findElement(By.xpath("//label[text() =
	 *       'Password']")).isDisplayed(), equalTo(true));
	 *       ExtentReport.logPass("PASS",
	 *       "test0000gLoginPageVerifyUsernameAndPasswordFieldLabelsAreDisplayed");
	 *       } catch (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000gLoginPageVerifyUsernameAndPasswordFieldLabelsAreDisplayed",
	 *       driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0000hLoginPageVerifyLoginButtonTextIsLogIn() throws
	 *       Throwable { try { if (printout) { System.out.println("Login Button
	 *       text: " + generalElement.getLoginPageButtonLogIn().getText()); }
	 *       assertThat(generalElement.getLoginPageButtonLogIn().getText(),
	 *       equalTo("Log In")); ExtentReport.logPass("PASS",
	 *       "test0000hLoginPageVerifyLoginButtonTextIsLogIn"); } catch
	 *       (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 *       "test0000hLoginPageVerifyLoginButtonTextIsLogIn", driver, e);
	 *       fail(e.getMessage()); } }
	 * 
	 *       public static void assertElementsAreDisplayed(WebElement[] elements,
	 *       boolean printout) { for (WebElement element : elements) { try {
	 *       assertTrue(element.isDisplayed()); if(printout){
	 *       System.out.println(element); } } catch (Throwable e) {
	 *       fail(e.getMessage()); } } }
	 */
	// ===== Global Tests ======//
	@Test
	 ...
	 * 
	 * @Test public void test0002LandingPageDataMaintenance() throws Throwable { try
	 ...
	 * ExtentReport.logPass("PASS", "test0002LandingPageDataMaintenance"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0002LandingPageDataMaintenance", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0003LandingPageBudgeting() throws Throwable { try {
	 ...
	 * ExtentReport.logPass("PASS", "test0003LandingPageBudgeting"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0003LandingPageBudgeting", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0004LandingPageEpisodes() throws Throwable { try {
	 ...
	 * ExtentReport.logPass("PASS", "test0004LandingPageEpisodes"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0004LandingPageEpisodes", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0005LandingPageContracting() throws Throwable { try {
	 ...
	 * generalElement.
	 * getLandingPageBubbleContractingQuickLinkContractingDataMaintenance() };
	 * assertElementsAreDisplayed(landingPageContractingElements, printout);
	 * ExtentReport.logPass("PASS", "test0005LandingPageContracting"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0005LandingPageContracting", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0006LandingPageCosting() throws Throwable { try {
	 ...
	 * ExtentReport.logPass("PASS", "test0006LandingPageCosting"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0006LandingPageCosting", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0007LandingPageReporting() throws Throwable { try {
	 ...
	 * ExtentReport.logPass("PASS", "test0007LandingPageReporting"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0007LandingPageReporting", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0008LandingPageAnalytics() throws Throwable { try {
	 ...
	 * ExtentReport.logPass("PASS", "test0008LandingPageAnalytics"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0008LandingPageAnalytics", driver, e); fail(e.getMessage()); } }
	 * 
	 * @Test public void test0009aGlobalHeader() throws Throwable { try {
	 * WebElement[] globalHeaderElements = { generalElement.getGlobalHeaderLogo(),
	 ...
	 * ExtentReport.logPass("PASS", "test0009aGlobalHeader"); } catch
	 * (Exception|AssertionError e) { ExtentReport.logFail("FAIL",
	 * "test0009aGlobalHeader", driver, e); fail(e.getMessage()); } }
	 */
	@Test
