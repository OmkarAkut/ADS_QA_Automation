...
public class GeneralContractInfo extends ContractModelsHelper {
  ...
  private static final String contractModel = "US7002 ACTUAL 1";
  ...
  public static void navigateToContractModelsPageFeeForServicePaymentTermsPage(String contractModel) {
    try {
      ...
      try {
        ...
        //added by Omkar on 51/7/2022 as the test is stopping because of pop up that asks if we want to continue in Read-Only mode.
        //This is the same pop up checked in above step
        driver.findElement(By.xpath("//*[contains(text(),'Read Only')]")).click();      
      } catch (Throwable e) {}
      waitForAjaxExtJs();
      Thread.sleep(2000);
      ...
      waitForSpinnerToEnd();
      waitForAjaxExtJs();
      driver.findElement(By.xpath("//td[contains(@class,'x-grid-cell-treecolumn')]/*[contains(text(),'General Information')]")).click();
      waitForAjaxExtJs();
      Thread.sleep(5000);
      waitForSpinnerToEnd();
      waitForAjaxExtJs();
