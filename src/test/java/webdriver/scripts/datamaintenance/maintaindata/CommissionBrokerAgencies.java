...
public class CommissionBrokerAgencies extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozCommissionBrokerAgencies= "Commission Broker Agencies";
	...
	static String[] commissionBrokerAgencyFilter= {"Name","Is","Equal To",name};
	static String[] commisionDialog=entity.split(" ");
	@BeforeClass
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("CommissionBrokerAgencies", "webdriver.scripts.datamaintenance.maintaindata",
				"CommissionBrokerAgencies");
		try {
			dmMap = BuildMap.getInstance(driver, DataMaintenanceMap.class);
			dialog = BuildMap.getInstance(driver, DialogsMap.class);
			Login.loginUser("AutomationTesterAdmin");
			goToPage("Maintain Data");
			selectMaintainDataAtoZ(aTozCommissionBrokerAgencies);
	...
	public void test01ValidateNewButton() throws Throwable {
		try {
			...
			doFilterCreate(commissionBrokerAgencyFilter);
