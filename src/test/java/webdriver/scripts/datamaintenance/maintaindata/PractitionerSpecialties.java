...
public class PractitionerSpecialties extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozPractitionerSpecialties = "Practitioner Specialties";
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozPractitionerSpecialties);
