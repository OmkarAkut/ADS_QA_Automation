...
public class ApDrgGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozApDrgGroups = "AP DRG Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Group Name","Is","Equal To",name};
	static String azName = "AP DRG Group";
	static ContractingMap contract;
	String[] columns = {"005  LIVER TRANSPLANT W MCC OR INTESTINAL TRANSPLANT  (2010APDRG)" ,"006  LIVER TRANSPLANT W/O MCC  (2010APDRG)"};
	String[] columnsEdit = { "007  LUNG TRANSPLANT  (2010APDRG)"};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozApDrgGroups);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozApDrgGroups,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozApDrgGroups,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add AP DRG Code Group Members");
