...
public class EAPGPaymentActionCodes extends AzHelper {

	static DataMaintenanceMap dmMap;
	final static String aTozEAPGPaymentActionCodes = "EAPG Payment Action Codes";
	...
	static String azName = "EAPG Payment Action Code";
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozEAPGPaymentActionCodes);
