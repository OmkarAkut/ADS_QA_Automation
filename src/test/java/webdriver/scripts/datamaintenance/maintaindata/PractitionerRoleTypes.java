...
public class PractitionerRoleTypes extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozPractitionerRoleTypes = "Practitioner Role Types";
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozPractitionerRoleTypes);
