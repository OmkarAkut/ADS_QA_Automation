...
public class ICDProcedureCodeGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozIcdProcCodeGroup= "ICD Procedure Code Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "ICD Procedure Code Group";
	static ContractingMap contract;
	String[] columns = {"0000 (ICD10 ICD10 Master)" ,"0001 Code 0001 (ICD ICD Master)"};
	String[] columnsEdit = { "0001 ICD 0001 (ICD10 ICD10 Master)"};
	String[] validateAgesBeforeEdit= {"ICD10" ,"ICD"};
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add ICD Procedure Code Group Members");
