...
public class TransactionTypeCodeGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozTransacTypeCodeGroup= "Transaction Type Code Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Transaction Type Code Group";
	static ContractingMap contract;
	String[] columns = {"1SM1 CENTRAL STATES HLTH & LIFE d" ,"1SM2 CENTRAL STATES HLTH & LIFE"};
	String[] columnsEdit = { "1SM3 CENTRAL VLY PNT/BEN ADM ADJ"};
	String[] validateAgesBeforeEdit= {"1SM1" ,"1SM2"};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozTransacTypeCodeGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozTransacTypeCodeGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozTransacTypeCodeGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Transaction Type Code Group Members");
