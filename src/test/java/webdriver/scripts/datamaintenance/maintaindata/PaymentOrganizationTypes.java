...
public class PaymentOrganizationTypes extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozPaymentOfOrganizationTypes = "Payment Organization Types";
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozPaymentOfOrganizationTypes);
