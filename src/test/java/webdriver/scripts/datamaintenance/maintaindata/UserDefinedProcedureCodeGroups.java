...
public class UserDefinedProcedureCodeGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozUserDefinedProcCodeGroup= "User Defined Procedure Code Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "User Defined Procedure Code Group";
	static ContractingMap contract;
	String[] columns = {"0200  O MODE UDPC 200 UDPC User Defined Procedure Codes s" ,"0300  O MODE UDPC 300 UDPC User Defined Procedure Codes s"};
	String[] columnsEdit = { "0400  O MODE UDPC 400 UDPC User Defined Procedure Codes s"};
	String[] validateAgesBeforeEdit= {"0200" ,"0300"};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozUserDefinedProcCodeGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozUserDefinedProcCodeGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozUserDefinedProcCodeGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add User Defined Procedure Code Group Members");
