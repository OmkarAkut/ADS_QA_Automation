...
public class DRG3Groups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozDRG3Group= "DRG 3 Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Group Name" + currentDateTime;
	static String[] filter= {"Group Name","Is","Equal To",name};
	static String azName = "DRG 3 Group";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("DRG3Groups", "webdriver.scripts.datamaintenance.maintaindata",
				"DRG3Groups");
		try {
			...
			selectMaintainDataAtoZ(aTozDRG3Group);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozDRG3Group,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozDRG3Group,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add DRG 3 Group Members");
