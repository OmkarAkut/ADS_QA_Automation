...
public class MedicareEntitlements extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozMedicareEntitlements = "Medicare Entitlements";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("MedicareEntitlements", "webdriver.scripts.datamaintenance.maintaindata",
				"MedicareEntitlements");
		try {
			dmMap = BuildMap.getInstance(driver, DataMaintenanceMap.class);
			Login.loginUser("AutomationTesterAdmin");
			goToPage("Maintain Data");
			selectMaintainDataAtoZ(aTozMedicareEntitlements);
