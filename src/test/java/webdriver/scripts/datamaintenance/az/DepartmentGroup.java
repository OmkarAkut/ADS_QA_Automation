...
public class DepartmentGroup extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozDepartmentGroup= "Department Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Department Group";
	...
	String[] columns = {"200100033235 UNKNOWN PatientCareDepartment 1833DEPT !833 Dept Master" ,"200100010800 UNKNOWN PatientCareDepartment 1833DEPT !833 Dept Master"};
	String[] columnsEdit = { "200100010720 UNKNOWN PatientCareDepartment 1833DEPT !833 Dept Master"};
	String[] validateAgesBeforeEdit= {"200100033235" ,"200100010800"};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozDepartmentGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozDepartmentGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozDepartmentGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Department Group Members");
