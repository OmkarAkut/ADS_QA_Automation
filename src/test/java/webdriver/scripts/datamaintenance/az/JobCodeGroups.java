...
public class JobCodeGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozIcdProcCodeGroup= "Job Code Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Job Code Group";
	static ContractingMap contract;
	String[] columns = {"000 000 job code (MARINA Marina Master)" ,"000001 SUPERVISOR (DEV default master DEV)"};
	String[] columnsEdit = { "000002 MANAGEMENT (DEV default master DEV)"};
	String[] validateAgesBeforeEdit= {"000001" ,"000"};
	String[] validateAgesAfterEdit=  {"000001" ,"000","000002"};
	@BeforeClass
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozIcdProcCodeGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozIcdProcCodeGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozIcdProcCodeGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Job Code Group Members");
