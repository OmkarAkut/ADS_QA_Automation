...
public class Locations extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozLocations = "Locations";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("Locations", "webdriver.scripts.datamaintenance.maintaindata",
				"Locations");
		try {
			dmMap = BuildMap.getInstance(driver, DataMaintenanceMap.class);
			Login.loginUser("AutomationTesterAdmin");
			goToPage("Maintain Data");
			selectMaintainDataAtoZ(aTozLocations);
