...
public class RevenueCodeGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozRevenueCodeGroup= "Revenue Code Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Revenue Code Group";
	static ContractingMap contract;
	String[] columns = {"003  Code3 F   (V8REGREVMASTER V8 Regression Rev Code Master)" ,"004  Code4 F   (V8REGREVMASTER V8 Regression Rev Code Master)"};
	String[] columnsEdit = { "005  Code5 F   (V8REGREVMASTER V8 Regression Rev Code Master)"};
	String[] validateAgesBeforeEdit= {"003" ,"004"};
	String[] validateAgesAfterEdit=  {"003" ,"004","005"};
	@BeforeClass
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozRevenueCodeGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozRevenueCodeGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozRevenueCodeGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Revenue Code Group Members");
