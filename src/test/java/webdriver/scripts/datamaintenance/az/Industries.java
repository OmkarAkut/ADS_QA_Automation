...
public class Industries extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozIndustries = "Industries";
	public static DialogsMap dialog;
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String currentDateCode = new SimpleDateFormat("MM.HH.ss").format(new java.util.Date());
	static String name="Name"+currentDateTime;
	static String code = currentDateCode.replaceAll("\\W", "");
	static String[] industriesFilter= {"Name","Is","Equal To",name};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozIndustries);
	...
	public void test02EditSaveCloseIndustries() throws Throwable {
		try {
			...
			String[] updatedIndustriesfilter= {"Name","Is","Equal To",updatedName};
			doClick(DataMaintenanceMap.getazClearFilterBtn());
			doClick(DataMaintenanceMap.getazFilterBtn());
			doFilterCreate(updatedIndustriesfilter);
