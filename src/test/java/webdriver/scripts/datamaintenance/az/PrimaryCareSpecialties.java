...
public class PrimaryCareSpecialties extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozPrimaryCareSpecialities = "Product Lines";
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozPrimaryCareSpecialities);
