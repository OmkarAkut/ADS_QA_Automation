...
public class ICDProcedureFeeScheduleMasters extends AzHelper{
	...
	static String masterClassificationScheme="1833ICDPROC 1800 ICD Proc Codes";
	static String[] aTozICDFeeScheduleMasterFilter= {"Name","Is","Equal To",name};
	static String sellerOfServices="0000  PRIVATE PAY";
	static String updatedName;
	static String azName="ICD Procedure Fee Schedule Master";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("ICDProcedureFeeScheduleMasters", "webdriver.scripts.datamaintenance.maintaindata",
				"ICDProcedureFeeScheduleMasters");
		try {
	...
	public void test01ValidateNewButton() throws Throwable {
		try {
			...
			keyInInputByName("code", code,"ICD Procedure Fee Schedule Master");
			keyInInputByName("name", name,"ICD Procedure Fee Schedule Master");
			clickButton("Select");
			...
			doFilterCreate(aTozICDFeeScheduleMasterFilter);
	...
	public void test11DeleteSchedule() throws Throwable {
		try {
			...
			doClick(DataMaintenanceMap.getwarningDeleteBtn());
			assertTextIsDisplayed("There is no data available to display.");
			ExtentReport.logPass("PASS", "test11DeleteICDFeeScheduleMaster");
		} catch (Exception | AssertionError e) {
			ExtentReport.logFail("FAIL", "test11DeleteICDFeeScheduleMaster", driver, e);
			fail(e.getMessage());
		}
	}
	@Test
	public void test12ICDFeeScheduleMaster() throws Throwable {
		try {
			...
			doClick(DataMaintenanceMap.getwarningDeleteBtn());
			assertTextIsDisplayed("There is no data available to display.");
			ExtentReport.logPass("PASS", "test12ICDFeeScheduleMaster");
		} catch (Exception | AssertionError e) {
			ExtentReport.logFail("FAIL", "test12ICDFeeScheduleMaster", driver, e);
			fail(e.getMessage());
		}
	}
	@AfterClass
