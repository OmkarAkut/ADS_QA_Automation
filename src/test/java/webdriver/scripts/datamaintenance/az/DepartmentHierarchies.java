...
public class DepartmentHierarchies extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozDepartmentHierarchies = "Department Hierarchies";
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozDepartmentHierarchies);
	...
	public void test01ValidateNewButton() throws Throwable {
		try {
			...
			keyInInputByName("name", name, "Department Hierarchy");
			clickCheckboxByName("masterCode");
			doDropdownSelectUsingOptionTextOnly(DataMaintenanceMap.getdeptMasterDrp(), deptMaster);
			driverDelay();
			CimHelper.dragAndDrop(driver.findElement(By.xpath("(//label[contains(text(),'Departments / Department Groups')]//following::div//table//td/div)[1]")), driver.findElement(By.xpath("(//label[contains(text(),'Hierarchy ')]//following::div[contains(@class,'glAccountsHierarchyGrid ')]//td/div)")));
	...
	public void test02ValidateEditDeptHierarchy() throws Throwable {
		try {
			...
			driverDelay();
			CimHelper.dragAndDrop(driver.findElement(By.xpath("(//label[contains(text(),'Departments / Department Groups')]//following::div//table//td/div)[2]")), driver.findElement(By.xpath("(//label[contains(text(),'Hierarchy ')]//following::div[contains(@class,'glAccountsHierarchyGrid ')]//td/div)[2]")));
