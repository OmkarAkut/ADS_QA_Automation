...
public class MemberStatuses extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozMemberStatuses = "Member Statuses";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("MemberStatuses", "webdriver.scripts.datamaintenance.maintaindata",
				"MemberStatuses");
		try {
			dmMap = BuildMap.getInstance(driver, DataMaintenanceMap.class);
			Login.loginUser("AutomationTesterAdmin");
			goToPage("Maintain Data");
			selectMaintainDataAtoZ(aTozMemberStatuses);
