...
public class StatisticGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozStatisticGroup= "Statistic Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Statistic Group";
	static ContractingMap contract;
	String[] columns = {"1CSM1 Pediatric Ambulatory Rev (Activity Statistics)" ,"1CSM2 Rehabilitation Rev (Ad Hoc Statistics)"};
	String[] columnsEdit = { "1CSM3 Pediatrics Salaries (Actual Gl Stat)"};
	String[] validateAgesBeforeEdit= {"1CSM1" ,"1CSM2"};
	String[] validateAgesAfterEdit=  {"1CSM1" ,"1CSM2","1CSM3"};
	@BeforeClass
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("StatisticGroups", "webdriver.scripts.datamaintenance.maintaindata",
				"StatisticGroups");
		try {
			...
			selectMaintainDataAtoZ(aTozStatisticGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozStatisticGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozStatisticGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Statistic Group Members");
