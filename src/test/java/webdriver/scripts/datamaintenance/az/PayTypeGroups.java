...
public class PayTypeGroups extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozPayTypeGroup= "Pay Type Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Pay Type Groups";
	static ContractingMap contract;
	String[] columns = {"101 Testing Regular option1 (150 old master 150)" ,"101 Selecting Regular option (DEPTMASTER Marina Department Master)"};
	String[] columnsEdit = { "101 Selecting regular option (AKT1 Test Master 1)"};
	String[] validateAgesBeforeEdit= {"150" ,"DEPTMASTER"};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozPayTypeGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozPayTypeGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozPayTypeGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Pay Type Group Members");
