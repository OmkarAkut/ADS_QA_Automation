...
public class MedicareCarriers extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozMedicareCarriers = "Medicare Carriers";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("MedicareCarriers", "webdriver.scripts.datamaintenance.maintaindata",
				"MedicareCarriers");
		try {
			dmMap = BuildMap.getInstance(driver, DataMaintenanceMap.class);
			Login.loginUser("AutomationTesterAdmin");
			goToPage("Maintain Data");
			selectMaintainDataAtoZ(aTozMedicareCarriers);
