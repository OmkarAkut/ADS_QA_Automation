...
public class MedicareTypes extends AzHelper {
	static DataMaintenanceMap dmMap;
	final static String aTozMedicareTypes = "Medicare Types";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("MedicareTypes", "webdriver.scripts.datamaintenance.maintaindata",
				"MedicareTypes");
		try {
			dmMap = BuildMap.getInstance(driver, DataMaintenanceMap.class);
			Login.loginUser("AutomationTesterAdmin");
			goToPage("Maintain Data");
			selectMaintainDataAtoZ(aTozMedicareTypes);
