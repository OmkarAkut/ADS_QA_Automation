...
public class BenefitPlanGroup extends AzHelper{
	static DataMaintenanceMap dmMap;
	final static String aTozBenefitPlanGroup= "Benefit Plan Groups";
	static String currentDateTime = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new java.util.Date());
	static String name = "Name" + currentDateTime;
	static String[] filter= {"Name","Is","Equal To",name};
	static String azName = "Benefit Plan Group";
	static ContractingMap contract;
	String[] columns = {"0 (DMBP Diane Marina Ben Plan Master) " ,"0001 PRIVATE PAY PENDING (1833BP2 1833 BP 2) "};
	String[] columnsEdit = { "0002 APP PENDING (1833BP2 1833 BP 2) "};
	String[] validateAgesBeforeEdit= {"0" ,"0001"};
	...
	public static void setupScript() throws Exception, Throwable {
		...
		try {
			...
			selectMaintainDataAtoZ(aTozBenefitPlanGroup);
	...
	public void test01ValidateSaveAndCreateNewGroup() throws Throwable {
		try {
			addNewScenario(validateAgesBeforeEdit,name,aTozBenefitPlanGroup,columns);
	...
	public void test02ValidateSaveCloseGroup() throws Throwable {
		try {
			addNewScenario(validateAgesAfterEdit,name,aTozBenefitPlanGroup,columns);
	...
	public void test03ValidateEditSaveGroup() throws Throwable {
		try {
			...
			waitForFormDialog("Add Benefit Plan Group Members");
