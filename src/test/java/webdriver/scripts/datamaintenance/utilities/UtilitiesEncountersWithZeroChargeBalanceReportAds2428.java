...
public class UtilitiesEncountersWithZeroChargeBalanceReportAds2428 extends UtilitiesPageHelper {

  static DataMaintenanceMap dm;
  final String reportName = "Encounters With Zero Charge Balance Report";
...
//      "eolheiser_Encounters With Zero Charge Balance Report_" + nameDate,
//      ".zip"
//  );
 ...
 * @throws Throwable */
  ...
  public static void setupScript() throws Throwable {
	  ExtentReport.reportCreate("UtilitiesEncountersWithZeroChargeBalanceReportAds2428","webdriver.scripts.datamaintenance.utilities", "UtilitiesEncountersWithZeroChargeBalanceReportAds2428");
...
//		loginUser(Users.ApplicationAdministrator1);
  ...
  List<String> encountersWithNoChargesReport = Arrays.asList(
      "======================================================",
      "Encounters with Zero Charge Balance Report",
      "======================================================",
      ...
      "0 Encounters with Zero Charge Balance",
