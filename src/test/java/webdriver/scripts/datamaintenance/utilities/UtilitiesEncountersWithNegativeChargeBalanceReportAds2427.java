...
public class UtilitiesEncountersWithNegativeChargeBalanceReportAds2427
  ...
  List<String> expectedZipDirectoryName = Arrays.asList(
      "automationappadmin1_Encounters With Negative Charge Balance Report_" + nameDate,
      ".zip"
  );
  ...
  public static void setupScript() throws InterruptedException, IOException {
    ...
    System.out.println(
        "Test Class: "
        + UtilitiesEncountersWithNegativeChargeBalanceReportAds2427.class.getSimpleName()
    );
