...
//  }
		...
		try {
			...
			try {
				...
				try {
					...
					driver.findElement(By.xpath("//button/span[text()='Cancel & Close']")).click();
					waitForSpinnerToEnd();
					ExtentReport.logFail("FAIL", "test03CostingCostModelsPageAssertRestrictedEntitiesDisplay", driver,
							e);
					fail(e.getMessage());
	...
	public void test04CostingCostModelsPageAssertRestrictedEntitiesDisplayOnCostComponentMaster() throws Throwable {
		try {
			...
			try {
				...
				waitForAjaxExtJs();
				Thread.sleep(2000);
				// waitUntilElementIsClickable(driver.findElement(By.xpath("//div/ul/li[contains(@class,'x-boundlist-item')
				// and text()='150 Marina Medical Center']/..")));
				// List<WebElement> list =
				// javaMakeListOfWebElements(driver.findElement(By.xpath("//div/ul/li[contains(@class,'x-boundlist-item')
				// and text()='150 Marina Medical Center']/..")),"li");
				// venkat updated xpath 31-10-2022

				waitUntilElementIsClickable(driver.findElement(By
						.xpath("(//*[text()='Entities']//following::div//div[text()='150  Marina Medical Center'])")));
				List<WebElement> list = driver.findElements(
						By.xpath("(//*[text()='Entities']//following::div//div[text()='150  Marina Medical Center'])"));
				...
				ExtentReport.logPass("PASS",
						"test04CostingCostModelsPageAssertRestrictedEntitiesDisplayOnCostComponentMaster");
			}
	...
	public void test07ContractModelsPageAssertDefinitionElementsProvidersTabContainsOnlyRestrictedEntity()
		...
		try {
			...
			try {
				driver.findElement(By.xpath("//span[@class='x-panel-header-text x-panel-header-text-default'][text()='"
						+ testContractModel1 + "']"));
				...
				// ExtentReport.logFail("FAIL","test07ContractModelsPageAssertDefinitionElementsProvidersTabContainsOnlyRestrictedEntity",driver,
				// e);
				// fail(e.getMessage());
				// } catch (Exception e1) {
			...
			ExtentReport.logFail("FAIL",
					"test07ContractModelsPageAssertDefinitionElementsProvidersTabContainsOnlyRestrictedEntity", driver,
					e);
			fail(e.getMessage());
		}
	...
	public void test08AssertDefinitionElementsAddProvidersSelectorContainsOnlyRestrictedEntity() throws Throwable {
		...
		try {
			...
			ExtentReport.logFail("FAIL",
					"test08AssertDefinitionElementsAddProvidersSelectorContainsOnlyRestrictedEntity", driver, e);
			fail(e.getMessage());
