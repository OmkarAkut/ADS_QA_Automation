...
public class ValidateWarningForRvuMaintenancePopUpAds1249 extends UcqcHelper {
  ...
  @Test
  public void test01aClickOverwriteRvusButtonAndAssertWarningForRvuMaintenancePopUpDisplays() {
    try {
  ...
  @Test
  public void test01bOnOverwriteRvuDialogAssertDialogElementsAreDisplayed() {
    try {
  ...
  @Ignore
  @Test
  public void test02ClickOverwriteButtonAndAssertWarningDailogDisappears() {
    try {
      waitForAjaxExtJs();
  ...
  @Ignore
  @Test
  public void test03ClickOverwriteButtonAndAssertWarningDailogDisappears() {
    try {
      Thread.sleep(1100);
      doClick(costingMap.getUnitCostQuickCalculationButtonOverwriteRVUMaintenance());
      ucqcWaitForSpinnerToEnd();
