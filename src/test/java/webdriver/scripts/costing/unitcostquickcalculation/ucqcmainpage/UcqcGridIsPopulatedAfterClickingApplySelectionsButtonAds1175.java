...
//ADS-5927 
  @Test
  public void testUcqcGridDisplaysAfterClickingApplySelectionsButton_ADS_5927() throws Throwable{
    try {
      waitForAjaxExtJs();
//      ucqcPopulateRequiredFieldsToDisplayGrid("QA Cost Model", "QA MHFY05 After Vol Change", "150 Marina Medical Center", "2110  ICU", "Apr 2004 to Mar 2005");
      ...
      ucqcPopulateRequiredFieldsToDisplayGrid("0-MarinaCostModel", "entity 150 dept 2016 2110 3520", "150 Marina Medical Center", "3010", "Oct 2004 to Oct 2004");
      applySelections("0ALL");
  ...
  //ADS-6644
  @Test
  public void testUcqcGridDisplaysAfterClickingApplySelectionsButton_ADS_6644() throws Throwable{
    try {
