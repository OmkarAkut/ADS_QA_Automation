...
public class ReportsLibraryVerifyTemplateDirectoryContents extends ReportsHelper {
  ...
  public static void setupScript() throws Exception,Throwable {
	  ExtentReport.reportCreate("ReportsLibraryVerifyTemplateDirectoryContents", "webdriver.scripts.reporting", "ReportsLibraryVerifyTemplateDirectoryContents");
    try {
  ...
  @Test
  public void test00VerifyReportTemplatesDirectoryReportsCount() throws Throwable,InterruptedException {
    try {
