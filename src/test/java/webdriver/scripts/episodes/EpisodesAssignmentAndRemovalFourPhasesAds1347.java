...
//			Omkar 14/04/2023 : xpath changes for 11.2
			webdriverClick(getWebElement("//div[text()='Triggers']/parent::div"));
	...
	public void doClickTree(String name) throws InterruptedException {
		//	Omkar 12/04/2023 : Change in xpath for 11.2
		//    waitForPresenceOfElement("//td[contains(@class,'x-grid-cell-treecolumn')]/div[text()='" + name + "']");
		waitForPresenceOfElement("//td[contains(@class,'x-grid-cell-treecolumn')]//span[text()='" + name + "']");
		//	Omkar 12/04/2023 : Change in xpath for 11.2
		//    driver.findElement(By.xpath("//td[contains(@class,'x-grid-cell-treecolumn')]/div[text()='" + name + "']")).click();
		driver.findElement(By.xpath("//td[contains(@class,'x-grid-cell-treecolumn')]//span[text()='" + name + "']")).click();
		waitForSpinnerToEnd();
		waitForAjaxExtJs();
		waitForSpinnerToEnd();
		Thread.sleep(1000);
