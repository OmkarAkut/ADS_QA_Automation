	...
	public void test01Validate_CalculateNow_20406() throws Throwable {
		try {
			...
			doClick(cimMap.getcimEditBtn());
			  ...
			  cimMap.getcimScenarioSearchInput().sendKeys("*CM1 TB MHFY05 After Vol Change");
				cimMap.getsearchIcon().click();
				driverDelay();
			  WebElement source=driver.findElement(By.xpath("(//div[contains(@class,'hierarchyGrid ')])[1]//div/table//div[contains(text(),'*CM1 TB MHFY05 After Vol Change')]"));
			  WebElement target=driver.findElement(By.xpath("(//div[contains(@class,'hierarchyGrid ')])[2]//div/table//div[contains(text(),'"+calcType+"')]"));
