...
public class Opps2020CalculationDeviceCreditAds2231 extends CalculationHelper {

  static final String modelName = "v102 REGRESSION OPPS 2020 Device Credit";
  final byte numberOfEfrs = 26;
  Opps2020Data opps2020 = new Opps2020Data();

  /** Regression: Automated test script for ADS-2231 - 2020 OPPS: Device Credit. */
  @BeforeClass
  public static void setupScript() throws Exception {
    System.out.println("Test Class: " + Opps2020CalculationDeviceCreditAds2231.class.getSimpleName());
  ...
  public void test02QueryDatabaseAndAssertValuesAreCorrect() throws ClassNotFoundException {
    getDataFromDatabaseAndAssertExpectedValues(
            opps2020.sqlQueryDeviceCredit,
            opps2020.expectedValuesDeviceCredit
    );
  }
