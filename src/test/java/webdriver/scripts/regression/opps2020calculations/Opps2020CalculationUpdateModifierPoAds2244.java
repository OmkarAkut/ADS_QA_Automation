...
public class Opps2020CalculationUpdateModifierPoAds2244 extends CalculationHelper {

  static final String modelName = "v102 REGRESSION OPPS 2020 Mod PO";
  ...
  public static void setupScript() throws Exception {
    System.out.println("Test Class: " + Opps2020CalculationUpdateModifierPoAds2244.class.getSimpleName());
  ...
  public void test02QueryDatabaseAndAssertValuesAreCorrect() throws ClassNotFoundException {
    getDataFromDatabaseAndAssertExpectedValues(
            opps2020.sqlQueryUpdateModifierPoLogic,
            opps2020.expectedValuesUpdateModifierPoLogic
    );
  }
