...
public class Opps2020CalculationJPackagingCAds2298 extends CalculationHelper {
  ...
  /** Regression: Automated test script for ADS-2298 - 2020 OPPS: J Packaging C. */
  @BeforeClass
  public static void setupScript() throws Exception {
    System.out.println("Test Class: " + Opps2020CalculationJPackagingCAds2298.class.getSimpleName());
