...
public class Opps2019JPackagingAndSiEqualsRAds1330 extends CalculationHelper {

  static final String folderName = "Regression v10.0";
  static final String modelName = "v10 REGRESSION 2019 OPPS J Pack SI=R A";
  final byte numberOfEfrs = 12;
  final byte errors = 0;
  final byte efrsCalculatedToZero = 2;
  Opps2019Data data = new Opps2019Data();

  /** Regression: Test ticket ADS-1330 - 2019 OPPS: J Packaging & SI=R */
  @BeforeClass
  public static void setupScript() throws Exception {
    System.out.println("Test Class: " + Opps2019JPackagingAndSiEqualsRAds1330.class.getSimpleName());
  ...
  public void test02QueryDatabaseAndAssertValuesAreCorrect() throws ClassNotFoundException {
    getDataFromDatabaseAndAssertExpectedValues(
            data.sqlQueryJPackagingAndSiEqualsR,
            data.expectedValuesJPackagingAndSiEqualsR
    );
  }
