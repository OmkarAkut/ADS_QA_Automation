...
public class Opps2019DeviceOffsets extends CalculationHelper {

  static final String folderName = "Regression v10.0";
  static final String modelName = "v10 REGRESSION 2019 OPPS Device Offset C";
  final byte numberOfEfrs = 17;
  final byte errors = 0;
  final byte efrsCalculatedToZero = 2;
  Opps2019Data data = new Opps2019Data();

  /** Automated test script for ADS-1332 - 2019 OPPS: Device Offsets. */
  @BeforeClass
  public static void setupScript() throws Exception {
    System.out.println("Test Class: " + Opps2019DeviceOffsets.class.getSimpleName());
  ...
  public void test02QueryDatabaseAndAssertValuesAreCorrect() throws ClassNotFoundException {
    getDataFromDatabaseAndAssertExpectedValues(
            data.sqlQueryDeviceOffsets,
            data.expectedValuesDeviceOffsets
    );
  }
}
