...
//  final static String aTozPage = "Price Lists";
	...
	public static void setupScript() throws Exception, Throwable {
		ExtentReport.reportCreate("GeneralCalculationsRunPriceListCalculationScenarioAds2274",
				"webdriver.scripts.regression.generalcalculations",
				"GeneralCalculationsRunPriceListCalculationScenarioAds2274");
		try {
			System.out.println(
...
//    openMaintainDataBatch(batch);//Scroll does not work so running the scripts using filter
	}
...
//  @Test
	public void test02VerifyDatabaseValueCountIsZero() throws ClassNotFoundException {
		calculationsAssertDbRowCount(GeneralCalculationsData.getPriceListEncounterAssignmentSql, "equal to", 0);
	}
...
//			deleteMyCalculationStatusFirstRow();
			...
			ExtentReport.logFail("FAIL",
					"test02ClickCalculateButtonAndAssertCalculationStatusSummaryDetailsMatchExpected", driver, e);
			fail(e.getMessage());
		} finally {
			try {
				doClosePageOnLowerBar("Calculation Status");
