...
//	    String status = getWebElement("(//table[@class='x-grid-table x-grid-table-resizer']//tr[2]//td[10])[3]//div").getText(); //venkat update xpath 08-09-2022
	    String status = getWebElement("(//table[@class='x-grid-table x-grid-table-resizer'])[8]//tr[2]//td[10][contains(@class,'x-grid-cell x-grid-cell-gridcolumn')]/div").getText(); //Shilpa update xpath 31-10-2022
