...
//below line is commented by Omkar as there are isues while running on Jenkins
	...
	// "C:/ADS_automation/AffinityDecisionSupport/src/selenium/chromedriver";
...
//    setBrowserDriver(browser);
	...
	/**
	 * teardown() is the global framework method to logout of the application and
	 * quit/close the driver object.
	 */
	@AfterClass
...
//    	url = "https://support-dev.harrispaas.com/alliance-webCont/alliance/index.jsp";
	...
	public static void setBrowserDriver(String browser) {
		// Omkar: Drivers value is overwritten to avoid having a fixed path from
		// property file
...
//			  options.addArguments("--disable-mobile-upload");
	...
	// If a database is repointed, the proper dbUrl should be moved to the
...
//    	dbUrl = "jdbc:oracle:thin:@10.204.20.101:1529:qareborn";
		...
		dbCredentials = Arrays.asList(dbUrl, "qa", "pass");
